            ...
            <div class="modal fade" id="addnew" tabindex="-1" role="dialog" aria-labelledby="addnew"
                ...
                <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <form action="{{ Route('admin.home.testimonials.add') }}" id="frmnewvalue" novalidate method="POST"
                            ...
                            <div class="modal fade" id="edt{{ $value->id }}" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ Route('admin.home.testimonials.update', $value->id) }}"
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <label>Name</label>
                                                <input type="text" name="name" id="rev" class="form-control"
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{ Route('admin.home.testimonials.delete', $value->id) }}"
