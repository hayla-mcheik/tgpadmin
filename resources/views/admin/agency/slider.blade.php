...
@section('content')
    ...
    <div class="card card-default">
        <div class="card-header">
            <h3 class="card-title">Agency Slider</h3>
            ...
            <div class="modal fade" id="addnew" tabindex="-1" role="dialog" aria-labelledby="addnew"
                ...
                <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <form action="{{ Route('admin.agency.slider.add') }}" id="frmnewvalue" novalidate method="POST"
            ...
            <script>
             ...
             <div class="card-body filterable">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        @foreach ( $agencyslider as $key => $value)
                            <tr>
                                <td>{{ $key + 1 }}</td>
                            ...
                            <div class="modal fade" id="edt{{ $value->id }}" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ Route('admin.agency.slider.update', $value->id) }}"
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{ Route('admin.agency.slider.delete', $value->id) }}"
