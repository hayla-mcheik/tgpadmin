    ...
    <div class="card card-default">
        ...
        <div class="card-body filterable" style="display: block;">
            ...
            <div class="modal fade" id="addnew" tabindex="-1" role="dialog" aria-labelledby="addnew"
                ...
                <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('admin.blog.details.add',$blog->id) }}" id="frmnewvalue" novalidate method="POST"
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    @foreach ($blog->BlogImages as $key => $value)
                        <tr>
                            <td>{{ $key + 1 }}</td>
                            <td align="center">
                            @if($value->type === 'image')
                        ...
                        <div class="modal fade" id="edt{{ $value->id }}" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ Route('admin.blog.details.update', [Request()->blogs_id,$value->id]) }}"
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="{{ Route('admin.blog.details.delete',[Request()->blogs_id,$value->id]) }}"
