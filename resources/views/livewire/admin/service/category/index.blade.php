            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4>Category 
                            <a href="{{ url('admin/service/category/create') }}" class="btn btn-primary btn-sm float-end">Add Category</a></h4>
</div>
...
<tbody>
    ...
    <tr>
        ...
        <td>
             <a href="{{ url('admin/service/category/'.$category->id.'/edit') }}" class="btn btn-success"><i class="fas fa-edit"></i></a>
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body" align="center">
                                            <label>Are you sure you want delete this category?</label>
                                        </div>
